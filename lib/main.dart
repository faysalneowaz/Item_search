                    ...
                    onChanged: (_){
                      setState(() {
                        if(controller.text != null){
                          onSearchTextChanged(controller.text.toLowerCase());
...
class UserDetails {
  ...
  UserDetails({this.id, this.firstName, this.lastName, this.profileUrl = 'https://cdn.maikoapp.com/3d4b/4qhf5/180h.png'});
